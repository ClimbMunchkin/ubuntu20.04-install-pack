...
var Stack = class Stack {
    constructor(ext, active, workspace) {
        this.widgets = null;
        this.active_id = 0;
        this.tabs = new Array();
    ...
    destroy() {
        ...
        for (const c of this.tabs) {
            ...
            if (this.workspace === this.ext.active_workspace()) {
                global.log(`showing`);
                (_b = (_a = this.ext.windows.get(c.entity)) === null || _a === void 0 ? void 0 : _a.meta.get_compositor_private()) === null || _b === void 0 ? void 0 : _b.show();
            }
        }
    ...
    reposition() {
        ...
        if (restack) {
            parent.add_child(this.widgets.tabs);
            for (const c of this.tabs) {
                if (Ecs.entity_eq(c.entity, this.active))
                    continue;
                const actor = (_a = this.ext.windows.get(c.entity)) === null || _a === void 0 ? void 0 : _a.meta.get_compositor_private();
                if (!actor)
                    continue;
                actor.hide();
            }
