...
var Ext = class Ext extends Ecs.System {
    ...
    find_monitor_to_retach(width, height) {
        ...
        return [primary, this.displays.get(primary)];
    }
    focus_window() {
...
function find_unused_workspace() {
    let new_work = null;
    let id = 0;
